        ...
        {loading ? (
          ...
          <>
            <section className="w-[30%] h-full p-4">
              <div className="p-3 mb-8 flex w-full "></div>
              <div className="w-full bg-slate-400 h-[60%] border rounded-lg shadow-2xl">
                {
                  <MapPage
                    start={{
            ...
            <section className="w-[70%] flex flex-col items-center h-full p-4">
              ...
              <biv className="flex mb-8  w-[50%] justify-between">
                <h1 className="bg-gray-50 border text-myColor border-gray-300 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[40%] ps-10 p-2.5 ">
