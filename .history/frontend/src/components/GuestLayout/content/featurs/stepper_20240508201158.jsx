...
function Stepper() {
  ...
  function verifierContenu(input) {
    // Vérifie si la longueur du texte est supérieure à 7
    if (input.length <= 7) {
      return false;
    }
  ...
  useEffect(() => {
    ...
    if (newUser.password.length > 0) {
      ...
      if ((capital && number && length && letter) == true) {
  ...
  }, [setCapital, setNumber, setLength, setLetter]);
