      ...
      <div className="w-full h-full flex text-myColor">
        {loading ? (
          <>
            ...
            <section className="w-[70%] flex justify-center animate-pulse h-full p-4">
              <div className="mt-4 h-6 w-[15%] rounded-lg bg-slate-400 text-sm"></div>
            </section>
          </>
        ) : (
          <>
            ...
            <section className="w-[70%] flex flex-col items-center h-full p-4">
              ...
              <div className="">
                <div className="flex w-full justify-between">
                  <ol className="relative border-s-4 h-[80px] border-teal-400">
                    <li className="mb-9 ms-6">
                      <span className="absolute flex items-center justify-center w-3 h-3 bg-[#255aaa] rounded-full -start-2 ring-3 ring-white"></span>
