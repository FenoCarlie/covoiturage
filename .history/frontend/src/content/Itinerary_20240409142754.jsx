          ...
          <div className="flex w-full">
            <div className="flex flex-col justify-center items-center relative transition-all duration-[450ms] ease-in-out w-[50%] p-6">
              <article className="border-w-full ease-in-out duration left-0 inline-block">
                ...
                <label
                  htmlFor="profile"
                  className="justify-start has-[:checked]:shadow-lg relative w-full h-16 p-2 ease-in-out duration-300 border-solid border-black/10 has-[:checked]:border group flex flex-row gap-3 items-center justify-center text-black rounded-xl"
                >
                  <IoMdTime className="h-7 w-7" />
