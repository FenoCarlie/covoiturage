        ...
        {loading ? (
          ...
          <>
            ...
            <section className="w-[70%] flex flex-col items-center h-full p-4">
              ...
              <p className="h-1 mb-8 w-[50%] rounded-lg bg-[#c9c9c96e] text-sm"></p>
              <biv className="flex w-[50%] justify-between">
                <h1
                  onClick={handlePalaceMenu}
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[40%] ps-10 p-2.5 "
                >
                ...
                <div
                  className={
                    palaceMenu
                      ? `fadeInDown animated -right-[14em] p-2  flex items-center justify-center z-10 w-56 top-0  origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ease-in-out duration-500`
                      : `hidden`
                  }
                  role="menu"
