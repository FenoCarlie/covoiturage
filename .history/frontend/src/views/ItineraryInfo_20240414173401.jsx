...
function ItineraryInfo() {
  ...
  const getItinerary = () => {
    ...
    const data = {
      _id: {
        $oid: "661be1f81201cbf2ef0607ad",
      },
      idUsers: "661673259bc225fe5011bac0",
      locStart: {
        name: "Ankirihiry, Toamasina, Atsinanana, Madagascar",
        coord: {
          lat: -18.1425919,
          lng: 49.3927745,
        },
      ...
      locEnd: {
        name: "67ha Sud, Antananarivo, Analamanga, Madagascar",
        coord: {
          lat: -18.9092485,
          lng: 47.5074975,
        },
    ...
    setItinerary(data);
    const formattedDate = new Date(data.dateDep.date).toLocaleDateString(
      "en-US",
      {
        month: "long",
        day: "numeric",
