...
function ItineraryInfo() {
  const { itineraryId, user, setNotification } = useStateContext();
  ...
  const onSubmit = async (ev) => {
    ...
    try {
      ...
      setNotification("Reservation successfully");
    } catch (error) {
                    ...
                    <li className="mb-10 ms-6">
                      ...
                      <span className="flex w-full justify-between">
                        ...
                        <FaMapMarkedAlt
                          ...
                          onClick={() =>
                            setMap(
                              itinerary.locStart?.coord.lng,
                              itinerary.locStart?.coord.lat
                            )
                          }
                        />
                      </span>
                    ...
                    <li className="ms-6">
                      ...
                      <span className="flex w-full justify-between">
                        ...
                        <FaMapMarkedAlt
                          ...
                          onClick={() =>
                            setMap(
                              itinerary.locEnd?.coord.lng,
                              itinerary.locEnd?.coord.lat
                            )
                          }
                        />
                      </span>
