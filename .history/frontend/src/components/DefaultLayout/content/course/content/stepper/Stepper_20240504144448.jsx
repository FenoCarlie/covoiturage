...
function Stepper() {
  ...
  const inStart = useState(document.getElementById("inStart"));
  const inEnd = useState(document.getElementById("inEnd"));
  ...
  useEffect(() => {
    //const startValue = inStart.querySelectorAll("input");
    //const endValue = inEnd.querySelectorAll("input");

    console.log(inStart, inEnd);
  }, []);
