        ...
        <div className="flex w-[45%] p-5">
          <div className="bg-[#aeb63d] p-4 rounded-lg mr-2">
            <ol className=" overflow-hidden space-y-8">
              ...
              <li className="relative flex-1  z-10  after:w-0.5 after:h-full after:z-0 after:bg-gray-200 after:inline-block after:absolute after:-bottom-12 after:left-4 lg:after:left-5">
