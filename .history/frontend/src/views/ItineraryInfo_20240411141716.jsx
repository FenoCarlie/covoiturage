...
<div className="flex items-start space-x-4 rtl:space-x-reverse mb-5">
   <div>
      ...
      <div className="flex -space-x-4 rtl:space-x-reverse">
         <img className="w-8 h-8 border border-white rounded-full dark:border-gray-800" src="/docs/images/people/profile-picture-5.jpg" alt=""/>
         <img className="w-8 h-8 border border-white rounded-full dark:border-gray-800" src="/docs/images/people/profile-picture-2.jpg" alt=""/>
         <img className="w-8 h-8 border border-white rounded-full dark:border-gray-800" src="/docs/images/people/profile-picture-3.jpg" alt=""/>
