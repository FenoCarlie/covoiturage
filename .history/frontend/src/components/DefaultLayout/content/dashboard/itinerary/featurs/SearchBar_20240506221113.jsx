        ...
        <div className="flex items-stretch justify-stretch p-1">
          <div className="relative w-full">
            ...
            <input
              ...
              className="bg-gray-50 hover:bg-[#eeeeee94] text-gray-900 text-lg rounded-lg focus:outline-none shadow-none focus:border-none focus:bg-[#eeeeee] block w-full ps-10 p-2.5"
              placeholder="From..."
              required
            />
          </div>
