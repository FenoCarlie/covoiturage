...
function Stepper() {
  ...
  useEffect(() => {
    ...
    const active = document.getElementById(step-${activeStep}); const value = active.querySelectorAll("input"); var index = 0; setIsEmpty(false); while (index < value.length) { if (value[index].value.trim() == "") { setIsEmpty(true); } index++; }
  }, [activeStep]);
