            ...
            <div className="p-10 text-base">
              ...
              <div className="relative">
                ...
                <div
                  className={
                    calendarMenu
                      ? `absolute fadeInDown animated palace-menu -right-[14em] p-2  flex items-center justify-center z-10 top-0 text-xl  origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ease-in-out duration-500`
                      : `hidden`
                  }
                  role="menu"
