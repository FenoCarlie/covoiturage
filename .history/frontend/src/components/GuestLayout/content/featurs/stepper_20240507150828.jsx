...
function Stepper() {
  ...
  useEffect(() => {
    setVerifIn(false);
    if ((newUser.email.length > 0 || newUser.phoneNumber.length) < 9) {
      setVerifIn(true);
    }
  }, [newUser]);
    ...
    <>
      ...
      >
        <div className="flex w-full flex-col py-6">
          ...
          <div className="relative mb-3">
            <input
              className={`no bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full ps-10 p-2.5 ${
      ...
      <button
        ...
        className={`text-white bg-[#124da5] p-3 w-full ${
          !verifIn
            ? "opacity-50 cursor-default"
            : "hover:bg-[#013d97] cursor-pointer"
        }`}
      >
        Next
      </button>
