          ...
          <>
            ...
            <section className="w-[70%] flex flex-col items-center h-full p-4">
              ...
              <biv className="flex mb-8 px-20 w-[50%] flex-row-reverse justify-between items-center">
                <div className="flex item center justify-between w-full items-center">
                  <h1>Are you sure you want to cancel this trip ?</h2>
                  <button
                    onClick={""}
                ...
                <button
                  onClick={onSubmit}
                  className="rounded-lg hidden text-white bg-red-600 px-5 py-2.5 hover:bg-red-700 hover:-translate-y-1 hover:scale-110 transition ease-in-out delay-150 "
                  type="button"
                >
                  Cancel
                </button>
