  ...
  return (
    <div className="h-full flex">
      <div className="w-[50%] m-3">
        <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-autolg:my-0">
          <div
            id="profile"
          ...
          >
            <div className="p-4 md:p-12 text-center lg:text-left">
              ...
              <p className="pt-4 text-base font-bold relative flex items-center justify-center lg:justify-start">
      ...
      <div className="w-[50%] m-3 bg-slate-600">course side</div>
    </div>
  );
}
