          ...
          {loading ? (
            ...
            Object.values(itinerary).map((item) => (
              <Link
                ...
                className="bg-[#ffffff] rounded-lg mb-4 p-6 w-[75%] flex flex-col"
                key={item.locStart + item.locEnd + item.dateDep}
              >
                <div className="flex w-full justify-between">
                  <ol className="relative border-s-4 h-[50px] border-teal-400">
                ...
                <div className="flex mt-16 justify-between">
                  ...
                  <div className="flex flex-col">
                    <div className="flex relative items-center">
                      <BsPersonPlusFill className="mr-6" />
                      <span>{item.carPlace}</span>
                    </div>
