        ...
        <div className="p-6 w-[40%] flex">
          <div className="flex flex-col items-center relative transition-all duration-[450ms] ease-in-out w-[50%]">
            ...
            <article className=" rounded-lg  bg-white border-w-full ease-in-out duration p-6 left-0 inline-block">
              ...
              <label
                htmlFor="price"
                className="hover:bg-black justify-start has-[:checked]:shadow-lg relative w-full h-14 p-2 ease-in-out duration-300 border-solid border-black/10 has-[:checked]:border group flex flex-row gap-3 items-center text-black rounded-xl"
              >
