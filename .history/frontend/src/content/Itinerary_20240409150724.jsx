    ...
    <>
      <div className="flex overflow-hidden h-full w-ful">
        ...
        <div className="p-3 w-[40%] flex">
          <div className="flex flex-col items-center relative transition-all duration-[450ms] ease-in-out w-[50%] p-6">
            <h1>Sort by</h1>
            <article className=" bg-white border-w-full ease-in-out duration left-0 inline-block">
              <label
                htmlFor="departure"
