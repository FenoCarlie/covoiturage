    ...
    <>
      <div className="flex overflow-hidden h-full w-ful text-myColor">
        ...
        <div className="p-6 w-[40%] flex">
          ...
          <div className="w-[50%] flex justify-center bg-slate-400">
            <section className="flex flex-col items-center relative transition-all duration-[450ms] ease-in-out w-[50%]">
              <h1 className="mb-6 font-bold text-xl">Departure time</h1>
              <ul className=" rounded-lg  bg-white border-w-full ease-in-out duration p-6 left-0 inline-block">
                <li className="hover:shadow-lg  mb-3 has-[:checked]:shadow-lg relative w-full h-14 p-4 ease-in-out duration-300 border-solid border-teal-400 has-[:checked]:border group flex flex-row gap-3 items-center justify-start text-black rounded-xl">
                  <label
