...
function Stepper() {
  ...
  const verifId = async (ev) => {
    ...
    try {
      ...
      const userPhone = PhoneResponse.data;

      if (userMail && userPhone) {
        if (userMail.length > 0 && userPhone.length > 0) {
          console.log("Both mail and phone are valid");
        } else if (userMail.length > 0) {
          console.log("Mail is valid, but phone is not");
        } else if (userPhone.length > 0) {
          console.log("Phone is valid, but mail is not");
        } else {
          console.log("Neither mail nor phone is valid");
        }
      } else {
